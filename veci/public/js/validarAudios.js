function validareAudios(i){
    var numAgente = $("#idAgente"+i).val(); 
    var tipicacion = $("#tipoTipicacion"+i).val();
    var  idUser  = $("#idUser").val(); 
    var nombreUser = $("#nombreUser").val();
  
    $.pgwModal({
       url: "./calidadAudios.php?numAgente="+numAgente+"&tipicacion="+tipicacion+"&idUser="+idUser+"&nombreUser="+nombreUser+"",
     maxWidth: 1200, 
