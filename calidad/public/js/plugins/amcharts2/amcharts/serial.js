    ...
    e.AmSerialChart = e.Class({
        ...
        countColumns: function() {
            ...
            for (l = 0; l < b; l++) {
                ...
                var g = e.stackType;
                if ("100%" == g || "regular" == g)
                    for (k = !1, h = 0; h < c; h++) d = this.graphs[h], d.tcc = 1, d.valueAxis == e && "column" == d.type && (!k && d.stackable && (a++, k = !0), (!d.stackable && d.clustered || d.newStack) && a++, d.columnIndex = a - 1, d.clustered || (d.columnIndex = 0));
                if ("none" == g || "3d" == g) {
                    k = !1;
        ...
        formatString: function(a,
            ...
            if (-1 != a.indexOf("[[category]]")) {
                ...
                if (this.categoryAxis.parseDates) {
                    var k = this.balloonDateFormat,
                        h = this.chartCursor;
                    h && (k = h.categoryBalloonDateFormat); - 1 != a.indexOf("[[category]]") && (k = e.formatDate(f, k, this), -1 != k.indexOf("fff") && (k = e.formatMilliseconds(k, f)), f = k)
                }
            ...
            a = e.formatValue(a, b.values, ["percents"], k); - 1 != a.indexOf("[[") && (a = e.formatDataContextValue(a, b.dataContext)); - 1 != a.indexOf("[[") && b.graph.customData && (a = e.formatDataContextValue(a, b.graph.customData));
...
(function() {
    ...
    e.Cuboid = e.Class({
        ...
        draw: function() {
            ...
            d = isNaN(r) ? 0 > f ? [x,
                M, B, C, I, z, D, F, L, b
            ] : [F, L, B, C, I, z, x, M, D, b] : K ? 0 < d ? [x, b, F] : [F, b, x] : 0 > f ? [x, b, F] : [F, b, x];
            e.setCN(c, b, t + "front");
            e.setCN(c, B, t + "back");
            e.setCN(c, F, t + "top");
            ...
            for (x = 0; x < d.length; x++)
                if (B = d[x]) a.push(B), e.setCN(c, B, t + "element");
        ...
        draw: function() {
            ...
            if (e.ifArray(a)) {
                ...
                var d = this.start,
                    ...
                    p, q, m = "",
                    m = e.extractPeriod(this.minPeriod),
                    w = e.getPeriodDuration(m.period,
                        m.count),
                    y, v, r, t;
                y = this.rotate;
                ...
                if (this.parseDates && !this.equalSpacing) this.lastTime = a[a.length -
                    1].time, this.maxTime = e.resetDateToMin(new Date(this.lastTime + 1.05 * w), this.minPeriod, 1, p).getTime(), this.timeDifference = this.endTime - this.startTime, this.parseDatesDraw();
                else if (!this.parseDates) {
                    if (this.cellWidth = this.getStepWidth(h), h < l && (l = h), k += this.start, this.stepWidth = this.getStepWidth(h), 0 < l)
                        for (l = Math.floor(h / l), h = this.chooseMinorFrequency(l), m = k, m / 2 == Math.round(m / 2) && m--, 0 > m && (m = 0), u = 0, this.end - m + 1 >= this.autoRotateCount && (this.labelRotationR = this.autoRotateAngle), b = m; b <= this.end + 2; b++) {
                            q = !1;
                            0 <= b && b < this.data.length ? (v = this.data[b], m = v.category, q = v.forceShow) : m = "";
                            if (t && !isNaN(h))
                                if (b / h == Math.round(b / h) || q) b / l == Math.round(b / l) || q || (this.gridAlpha = this.minorGridAlpha, m = void 0);
                                else continue;
                            else if (b / l != Math.round(b / l) && !q) continue;
                            ...
                            u++;
                            C = this.cellWidth;
                            y && (C = NaN, this.ignoreAxisWidth ||
                                !c.autoMargins) && (C = "right" == this.position ? c.marginRight : c.marginLeft, C -= this.tickLength + 10);
                    ...
                    u = m;
                    if (this.data[m].time != e.resetDateToMin(new Date(this.data[m].time), f, y, p).getTime())
                        for (p = 0, a = w, b = m; b < A; b++) h = this.data[b].time, this.checkPeriodChange(f, y, h, a) && (p++, 2 <= p && (u = b, b = A), a = h);
                    t && 1 < y && (h = this.chooseMinorFrequency(y),
                        e.getPeriodDuration(f, h));
                    if (0 < this.gridCountR)
                        for (b = m; b < A; b++)
                            if (h = this.data[b].time, this.checkPeriodChange(f, y, h, w) && b >= u) {
                ...
                for (b = 0; b < this.data.length; b++)
                    if (u = this.data[b]) this.parseDates && !this.equalSpacing ? (g = u.time, n = this.cellWidth, "MM" == this.minPeriod && (n = 864E5 * e.daysInMonth(new Date(g)) * this.stepWidth, u.cellWidth = n), g = Math.round((g - this.startTime) *
