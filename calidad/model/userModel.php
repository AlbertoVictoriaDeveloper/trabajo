...
FROM
	token
INNER JOIN usuarios ON token.usuarios_id = usuarios.id
INNER JOIN monitorista where token = '".$token."'"; 
    ...
    public function GetUserExist($nombre,$password){
    $consulta = "SELECT * FROM usuarios where user = '".$nombre."' and password = '".$password."'"; 
